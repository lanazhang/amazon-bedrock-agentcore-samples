...
class AgentCoreDeployer:
    ...
    def deploy_mcp_gateway(self) -> Optional[Dict]:
        ...
        if self.websocket_folder not in ('02-strands-ws', '03-langchain-transcribe-polly-ws'):
            return None
    ...
    def deploy_agent(self, role_arn: str, gateway_info: Optional[Dict] = None, memory_info: Optional[Dict] = None) -> Dict:
...
Environment Variables:
  ...
  AWS_REGION    AWS Region (default: us-east-1)
    ...
    parser.add_argument(
        'websocket_folder',
        choices=['01-bedrock-sonic-ws', '02-strands-ws', '03-langchain-transcribe-polly-ws', '04-pipecat-sonic-ws', 'echo', 'webrtc-kvs'],
