...
class AgentCoreCleanup:
    ...
    def _print_available_folders(self):
        ...
        print("\nAvailable folders:")
        for folder in ['01-bedrock-sonic-ws', '02-strands-ws', '03-langchain-transcribe-polly-ws', '04-pipecat-sonic-ws', 'echo']:
...
Examples:
  ...
  python cleanup.py 02-strands-ws
    ...
    parser.add_argument(
        'websocket_folder',
        choices=['01-bedrock-sonic-ws', '02-strands-ws', '03-langchain-transcribe-polly-ws', '04-pipecat-sonic-ws', 'echo'],
