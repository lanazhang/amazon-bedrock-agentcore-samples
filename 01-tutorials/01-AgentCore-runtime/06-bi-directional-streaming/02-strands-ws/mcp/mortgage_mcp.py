...
def calculate_mortgage_payment(loan_amount: float, interest_rate: float, loan_term_years: int, down_payment: float = 0) -> str:
    ...
    response = {
        ...
        "monthly_payment": {
            ...
            "total_monthly": round(monthly_payment + (loan_amount * 0.012 / 12) + (loan_amount * 0.005 / 12) + (principal * 0.005 / 12 if down_payment < loan_amount * 0.2 else 0), 2)
        },
        "loan_summary": {
...
def check_mortgage_eligibility(customer_id: str, annual_income: float, monthly_debts: float, credit_score: int) -> str:
    ...
    response = {
        ...
        "eligibility": {
            ...
            "credit_tier": "Excellent" if credit_score >= 740 else "Good" if credit_score >= 670 else "Fair" if credit_score >= 620 else "Poor"
        },
        "financial_ratios": {
...
TOOLS = [
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "interest_rate": {"type": "number", "description": "Annual interest rate (e.g., 6.5 for 6.5%)"},
                "loan_term_years": {"type": "integer", "description": "Loan term in years (e.g., 30)"},
                "down_payment": {"type": "number", "description": "Down payment amount", "default": 0}
            },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "required": ["customer_id", "annual_income", "monthly_debts", "credit_score"]
        }
    ),
    Tool(
        ...
        inputSchema={
            "type": "object",
            "properties": {
                "application_id": {"type": "string", "description": "The mortgage application ID"}
            },
